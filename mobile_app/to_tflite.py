...
def convert_h5(input_model_file, output_model_file, quantize=True):
...
if __name__ == '__main__':
    ...
    convert_h5('../models/affectnet_emotions/mobilenet_7.h5', 'app/src/main/assets/emotions_mobilenet',quantize=True)
